...
function useTabPanel(_ref) {
  ...
  const context = (0, import_react5.useContext)(TabContext_default);
  if (!context)
    ...
    return (0, import_jsx_runtime2.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime2.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime2.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime2.jsx)(Component, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react6.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react6.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
//# sourceMappingURL=chunk-MB56CSOV.js.map
